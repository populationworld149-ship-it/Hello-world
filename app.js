/* =========================================================
  Cafe menu/order template (placeholder content)
  - Categories update the central "plate" list
  - Selecting an item updates the details panel
  - Add to Order persists cart + loyalty points in localStorage
  - Ingredients modal includes allergen placeholders
  - Account modal shows loyalty progress
  - Cart page lists items, total, and "Place Order" simulation
  - Floating chatbox modal (message + email)
========================================================= */
...
// Dummy menu data — swap later with real categories/items.
// Note: Prices here are placeholders only (used for demo total calculations).
const MENU = [
  {
    id: "cat-a",
    name: "Category A",
    ...
    items: [
      mkItem("a-1", "Item 1", 4, ["Ingredient 1", "Ingredient 2", "Ingredient 3"], {
        nuts: false,
        dairy: true,
        gluten: false,
        soy: false,
      }),
      mkItem("a-2", "Item 2", 5, ["Ingredient 1", "Ingredient 2"], {
        nuts: false,
        dairy: false,
        gluten: true,
        soy: false,
      }),
      mkItem("a-3", "Item 3", 6, ["Ingredient 1", "Ingredient 2", "Ingredient 3", "Ingredient 4"], {
        nuts: true,
        dairy: false,
        gluten: false,
        soy: false,
      }),
      mkItem("a-4", "Item 4", 7, ["Ingredient 1"], {
        nuts: false,
        dairy: false,
        gluten: false,
        soy: true,
  ...
  },
  {
    ...
    items: [
      mkItem("b-1", "Item 1", 3, ["Ingredient 1", "Ingredient 2"], {
        nuts: false,
        dairy: true,
        gluten: true,
        soy: false,
      }),
      mkItem("b-2", "Item 2", 6, ["Ingredient 1", "Ingredient 2", "Ingredient 3"], {
        nuts: true,
        dairy: false,
        gluten: true,
        soy: false,
      }),
      mkItem("b-3", "Item 3", 8, ["Ingredient 1"], {
        nuts: false,
        dairy: true,
        gluten: false,
        soy: false,
  ...
  },
  {
    ...
    items: [
      mkItem("c-1", "Item 1", 2, ["Ingredient 1", "Ingredient 2"], {
        nuts: false,
        dairy: false,
        gluten: false,
        soy: false,
      }),
      mkItem("c-2", "Item 2", 5, ["Ingredient 1", "Ingredient 2", "Ingredient 3"], {
        nuts: false,
        dairy: true,
        gluten: false,
        soy: true,
      }),
      mkItem("c-3", "Item 3", 9, ["Ingredient 1", "Ingredient 2", "Ingredient 3", "Ingredient 4"], {
        nuts: true,
        dairy: true,
        gluten: true,
        soy: false,
      }),
      mkItem("c-4", "Item 4", 4, ["Ingredient 1"], {
        nuts: false,
        dairy: false,
        gluten: true,
        soy: false,
...
function mkItem(id, title, priceDollars, ingredients, allergens) {
  return {
    id,
    title,
    description:
      "Placeholder item description. Replace later with real product details.",
...
function wireMenuPage() {
  ...
  if (!catsRoot || !itemsRoot || !plate || !catTitle || !catDesc) return; // not on menu page
  ...
  function animatePlateSwap(doRender) {
    ...
    const onEnd = () => {
      ...
      doRender();
      // Bring new content in from the left
...
function wireCartPage() {
  ...
  if (!list || !empty || !totalEl || !placeBtn || !status) return; // not on cart page
